...
export default function ConversationCard({ user }: ConversationCardProps) {
    ...
    return (
        <div onClick={handleClick} className="w-11/12 relative h-16 gap-4 bg-slate-800   hover:bg-slate-950 text-white  my-2 flex items-center cursor-pointer rounded-2xl px-4 mx-4 justify-start  transition-all duration-700">
